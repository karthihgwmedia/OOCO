...
function windowresize()
{
	...
	var documentHeight=windowHeight+$('footer').height();	
...
$(document).ready(function(){
	...
	$("aside.animate .slimContentContainer").live("mouseenter",function(){
		$(this).niceScroll({cursorborderradius :"0px",cursorcolor:"#000"}); 
	})
...
<p class="txt_center_align"><img src="images/Ocoo_websiteBackground.jpg" class="bgImge" /></p>
<div id="wrapper">  
  <div class="row">   	
  ...
  <div class="shopAnimation" id="shopOrder">
    ...
    <div class="orderLinks">
      <div cass="columns twelve">
        ...
        <div class="columns ten"> <a href="#">View Cart</a> </div>
        <div class="columns one">&nbsp;</div>
        <div class="clear"></div>
      </div>
      <div class="clear"></div>
