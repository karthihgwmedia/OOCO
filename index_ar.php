...
$(document).ready(function(){
	...
	$("#menu a.clSlideIn").live("click",function(e){		
		...
		{
			$(nav_cur_page+" .slimContentContainer").niceScroll({cursorborderradius :"0px",cursorcolor:"#000"}); 
		}
	...
	$(".animate .pagination a").live('click',function(e){
		...
		$(cur_page+" .slimContentContainer").niceScroll({cursorborderradius :"0px",cursorcolor:"#000"});
...
<link href="style_ar.css" media="all" rel="stylesheet" type="text/css"/>
...
<header id="header">
  <div class="row">
    <div class="three columns logo clsFloatRight"> <img src="images/OCOOlogo_header_ar.png" /></div>
    <div class="nine columns clsFloatLeft" id="menuDiv">
      <div class="carousel">
      <nav id="menu">
        <ul class="nav-bar">
...
<div id="wrapper">  
  <div class="row">   	
    <div class="columns twelve"> <a href="#"><img src="images/main_logo_ar.png" class="main_logo" /></a></div>
    <div class="clear"></div>    
    <div class="columns twelve" id="threeCols">
      <div class="four columns" id="clsOcooBenefits">
        ...
        <div class="clsBenefits clearfix">
          ...
          <div class="clsMoreLink clsFloatLeft"> <a href="#">More</a> </div>
        </div>
        <div class="clsBenefits clearfix">
          <div class="clsBenefitsTle"> Anti-Aging </div>
          <div class="clsBenefitsDesc"> Sed condimentum tincidunt condimentum. Maecenas eleifend lacinia iaculis. Phasellus cursus fermentum risus eget molestie. </div>
      ...
      <div class="four columns" id="clsOcooOrders">
        ...
        <div class="clsProductCon">
          <div class="clsProduct">
            <div class="clsProductTle clsFloatRight columns eight"> <strong>1 DAY</strong> Single sodales nulla id est laoreet. </div>
            <div class="clsFloatLeft clsOrderLink"> <a class="shopOrderLink" href="#shopOrder">Order</a> </div>
            <div class="clear"></div>
          </div>
          <div class="clsProduct">
            <div class="clsProductTle clsFloatRight columns eight"> <strong>1 DAY</strong> Single sodales nulla id est laoreet. </div>
